    ...
    <div className="relative">
      ...
      <div
        ...
        style={{
          width,
          height,
          background: 'linear-gradient(180deg, #0D0D2B 0%, #000000 50%, #0D0D2B 100%)',
        }}
      >
        ...
        {(gameOver || gameWon) && (
          <div 
            className={`absolute inset-0 flex flex-col items-center justify-center bg-black/80 z-50 ${gameOver ? 'game-over-shake' : 'level-flash'}`}
          >
            <div 
        ...
        {isPowerMode && !gameOver && !gameWon && (
          <div 
            ...
            style={{
              background: 'radial-gradient(circle at center, transparent 30%, rgba(0, 0, 255, 0.1) 100%)',
